...
//===> Si ça marche pas    foreach (var neighbourCellIndex in GrilleSudoku.IndicesVoisinages)
                {
            ...
            IAlgorithm algo2 = new GibbsSampling();
            IAlgorithm algo3 = new VariationalMessagePassing();
            IAlgorithm algo4 = new MaxProductBeliefPropagation();
            //les algos ont ete teste cependant la difference lors du lancement du projet n'est pas facilement visible
            algo2.DefaultNumberOfIterations = 50;
            algo2.DefaultNumberOfIterations = 200;
